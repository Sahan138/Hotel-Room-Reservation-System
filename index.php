            ...
            <div class="row projects">
                <div class="col-sm-6 item">
                    <div class="row">
                        ...
                        <div class="col">
                            <h3 class="name">Sea Side Galle</h3>
                            <p class="description">Wonderful beach hotel situtated in the beautiful southern beach of Sri Lanka.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 item">
                    <div class="row">
                        ...
                        <div class="col">
                            <h3 class="name">Sea Side Colombo</h3>
                            <p class="description">Enourmous luxurious beach hotel just in the heart of Sri Lanka.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 item">
                    <div class="row">
                        ...
                        <div class="col">
                            <h3 class="name">Sea Side Hikka/h3>
                            <p class="description">Enjoy the beauty of natural coral reefs by spending your vacation at Beach Hotel Sea Side Hikka.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 item">
                    <div class="row">
                        ...
                        <div class="col">
                            <h3 class="name">Sea Side Pasikudah</h3>
                            <p class="description">Sea Side Pasikudah has the most beautiful beach in Sri Lanka. enjoy the beach and the white sand at your next vacation at Sea Side Pasikudah.</p>
                        </div>
                    </div>
                </div>
            </div>
